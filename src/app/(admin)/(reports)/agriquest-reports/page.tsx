...
import { AgriquestWithRelations, TradesWithRelations } from '@/app/(trader-page)/agrifeed/_components/_types'
import { ColumnTradeReports } from '../_components/ColumnTradeReports'
import { fetchAgriQuestTransactionsByDateRange } from '../../../../../actions/agriquest'
import { ColumnQuestReports } from '../_components/ColumnQuestReports'
import html2canvas from 'html2canvas'
import jsPDF from 'jspdf'

const TradeReportsPage = () => {
    const [date, setDate] = useState<DateRange | undefined>(undefined);
    const [trades, setTrades] = useState<AgriquestWithRelations[]>([])
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const data = await fetchAgriQuestTransactionsByDateRange(startDate, endDate);
                setTrades(data as AgriquestWithRelations[])
            } catch (error) {
    ...
    const downloadPDF = () => {
        ...
        html2canvas(input).then((canvas) => {
            ...
            pdf.save('Agriquests-Report.pdf');
        });
    }
    ...
    return (
        <div>
            ...
            <div className='flex justify-between items-center'>
                <AdminTitle entry='1' title='Agriquest Reports' />
